      ...
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        ...
        rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            ...
            turpis pulvinar, est scelerique ligula sem
          </p>
          <div className="flex flex-col space-y-4 sm:items-center sm:jusitfy-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <a
